...
import bgaudio from "./assets/mp3/bg.mp3"
...
instance.interceptors.response.use(function (response) {
  ...
  // if (axiosUserControl.autoShowErrorMessage && response.data){
...
//   buttonAudio.setAttribute('src',bgaudio)
//   buttonAudio.play()
// }

// 注册一个全局播放音效指令 `v-audio`
Vue.directive('audio', {
  bind: function(el) {
    el.audio = function() {
      let buttonAudio = document.getElementById('buttonAudio');
    ...
    el.addEventListener('click', el.audio)
  }
})
